...
export default function Info() {
  ...
  return (
    <div className="mt-[120px] flex flex-col">
      ...
      <h3 className="text-transparent max-md:text-3xl bg-clip-text bg-gradient-to-r from-violet-500 via-purple-500 to-pink-500 text-6xl font-semibold leading-[80px] animate-fadeUp3 mt-1">
      ...
      <a
        ...
        className="w-fit p-[12px_20px] max-md:p-[8px_14px] mt-7 font-medium border-[1.5px] rounded-md border-violet-500 text-violet-500 animate-fadeUp5"
      >
        Check out my Resume!
      </a>
    </div>
