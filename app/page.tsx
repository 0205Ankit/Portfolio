...
import ButtonMailto from "@/components/MailLink";
      ...
      <div className="w-8/12 mx-auto">
        ...
        <div className="mt-[300px]">
          ...
          <div className="mt-10 text-gray-300 flex gap-10">
            <div className="w-[60%]">
              <p>
                Hello! My name is Ankit and I enjoy creating things that live on
                the internet. My interest in web development started 3 years ago
                in freshman year of my college, I first started with basic HTML
                & CSS and work my way through technologies, currently i am
                working with following stack.
              </p>
              <p className="mt-2">
              ...
              <p className="mt-2">
                ...
                <a className="text-violet-500" href="https://itaxeasy.com" target="_blank">itaxEasy</a> as a Web Dev Intern,
                where I contributed to the successful management and enhancement
                of the application's frontend.
              </p>
            </div>
